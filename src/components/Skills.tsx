                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 sm:gap-4 justify-items-center">
                    {categorySkills.map((skill) => (
                      <div
                        ...
                        rounded-2xl shadow-md hover:shadow-blue-500/20
                        p-5 w-36 h-44 sm:w-40 sm:h-48
                      ...
                      >
                        ...
                        {/* Nombre y categoría */}
                        <h4 className="text-sm font-semibold text-slate-800 dark:text-white text-center uppercase tracking-wide">
                          {language === 'es' ? skill.name_es : skill.name_en}
                        </h4>
                        <p className="text-xs text-slate-500 dark:text-slate-300 text-center mb-2">
